...
const { isSame } = require(path.join(__dirname, "..", "middlewares", "isSame"));
...
router.delete("/:postId", isAuthorized, isSame, deletePost);

router.put("/:postId", isAuthorized, isSame, updatePost);
